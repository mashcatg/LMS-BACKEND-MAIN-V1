...
try {
    ...
    // Fetch all students from the enrollments table where course_id matches
    ...
    // Initialize an array to hold marks for each student
    $marksData = [];
    ...
    foreach ($students as $student) {
        ...
        // Prepare marks data for the student
        $marksData[] = [
            'student_index' => $student['student_index'],
    ...
    usort($marksData, function($a, $b) {
        return $b['total_marks'] - $a['total_marks'];
    });

    // Send response with exam details and all students' marks
    echo json_encode([
        'success' => true,
        'marks' => [
